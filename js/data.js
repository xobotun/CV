var data = function(){
	return {
		...
		{
			name: "Бауманец",
			where: "МГТУ им. Н. Э. Бвумана",
			began: "2013",
			ended: "2017",
			description: "Бакалавр с кафедры ИУ6 \"Компьютерные системы и сети\". Изучали 60% программирования, 25% микроконтроллеров и схемотехники и 15% администрирования сетей.",
			proof_url: null,
